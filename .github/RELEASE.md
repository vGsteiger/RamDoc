...
- **macOS `.dmg` disk image** (filename generated by Tauri, e.g., `DokAssist_<version>_<arch>.dmg`) for easy installation
- **macOS `.app` bundle tarball** (`DokAssist_<version>_macos.app.tar.gz`) as uploaded by the workflow
