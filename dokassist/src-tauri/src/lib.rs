...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::llm::ensure_writing_model_loaded,
            commands::llm::unload_model,
            commands::llm::get_router_diagnostics,
            commands::llm::unload_router_model,
            commands::llm::set_router_model_override,
            ...
            commands::chat::list_chat_draft_versions,
            commands::chat::append_chat_draft_version,
